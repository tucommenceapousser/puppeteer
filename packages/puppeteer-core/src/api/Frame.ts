...
} from '../common/DeviceRequestPrompt.js';
import {ExecutionContext} from '../common/ExecutionContext.js';
import {FrameManager as CDPFrameManager} from '../common/FrameManager.js';
...
export class Frame {
   ...
   */
  _navigated(
    framePayload: Protocol.Page.Frame | Bidi.BrowsingContext.NavigationInfo
  ): void;
  _navigated(): void {
    throw new Error('Not implemented');
  }
