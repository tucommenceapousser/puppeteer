...
export class Frame extends BaseFrame {
  ...
  override _frameManager: FrameManager;
  override _id: string;
  override _loaderId = '';
  override _name?: string;
  override _hasStartedLoading = false;
  override _lifecycleEvents = new Set<string>();
  ...
  override updateClient(client: CDPSession): void {
    this.#client = client;
    this.worlds = {
  ...
  override parentFrame(): BaseFrame | null {
    return this._frameManager._frameTree.parentFrame(this._id) || null;
  }

  override childFrames(): BaseFrame[] {
  ...
  override _deviceRequestPromptManager(): DeviceRequestPromptManager {
    if (this.isOOPFrame()) {
  ...
  override _navigated(framePayload: Protocol.Page.Frame): void {
